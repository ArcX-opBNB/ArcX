                ...
                try {
                    ...
                    ViewTreeObserver.OnGlobalLayoutListener layoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
                        ...
                        public void onGlobalLayout() {
                            ...
                            int b = r.bottom;//1339
                            int top = r.top;//89
                            int height = r.height();//1250
                            int size = AppUtil.getSize(406);//2332
                            int height1 = activityRoot.getRootView().getHeight();//2248
                            int b1 = activityRoot.getRootView().getBottom();//2248


                            int heightDiff = height1 -b;
                            ...
                            wasOpened = isOpen;
                            EventBus.getDefault().post(new KeyboardVisibleEvent(isOpen, heightDiff));
                        }
                    };
            ...
            public void onActivityDestroyed(Activity activity) {
                try {
                    ...
                    if (layoutListener != null) {
                        if (wasOpened) {
                            EventBus.getDefault().post(new KeyboardVisibleEvent(!wasOpened, 0));
                        }
